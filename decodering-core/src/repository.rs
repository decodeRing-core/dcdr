...
pub trait PrincipalAppGrantRepository: Send {
    ...
    fn list_by_app(
        ...
        limit: i64,
        offset: i64,
    ) -> impl Future<Output = Result<Vec<PrincipalAppGrantView>, DbError>> + Send;
    fn count_by_app(&mut self, app_id: &str) -> impl Future<Output = Result<i64, DbError>> + Send;
}
...
pub trait UserRepository: Send {
    ...
    fn list(
        ...
        limit: i64,
        offset: i64,
    ) -> impl Future<Output = Result<Vec<User>, DbError>> + Send;
    ...
    fn get_by_id(&mut self, id: i64) -> impl Future<Output = Result<Option<User>, DbError>> + Send;
